      ...
      <div class="grid-container">
         ...
         <main class="main-container">
            <?php 
               ...
               ?>
            <div>          
               <button class="deleteuser2" onclick="deleteuser()" value="<?php echo $username ?>" id="delete"> Delete User </button>      
            </div>
            <div class="start">
               <h1><?php echo $nameuser ?> has not created a portfolio yet</h1>
            </div>
            <?php }else{  ?>
            <div class="container">
               <div class="main-body">
                     ...
                     <div class="col-md-8">
                        ...
                        <div class="row">
                           ...
                           <div>
                              <br>
                              <div>         
                                 <button class="deleteuser" onclick="deleteuser()" value="<?php echo $username ?>" id="delete"> Delete User </button>       
                              </div>
                           </div>
                        </div>
                     </div>
